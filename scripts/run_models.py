...
def run_models(data_path:str, outdir:str, log_y:bool=False):
    ...
    for t in target_variables:
        ...
        trainval_tb, test_tb = preprocessor.preprocess_lidar(target_col=t, 
...
if __name__ == '__main__':
    # Todo argparse
    run_models('../../enveco_data/enveco/', 'results_log', True)